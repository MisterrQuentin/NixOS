      ...
      in
        concatStrings [
          ''
            ...
            exec-once = pkill swww || true; swww init && swww img /home/${username}/zaneyos/config/wallpapers/wallpaper.jpg
            ...
            exec-once=[workspace 4 silent] ${pkgs.appimage-run}/bin/appimage-run /opt/appimages/session-desktop-linux-x86_64-1.14.5.AppImage
