...
<img align="center" width="80%" src="https://github.com/bimmerr2019/NixOS/-/raw/main/config/demo.png" />    
...
sh <(curl -L https://github.com/bimmerr2019/NixOS/raw/main/install-zaneyos.sh)
```
...
```
git clone https://github.com/bimmerr2019/NixOS.git $HOME/zaneyos
cd zaneyos
```
